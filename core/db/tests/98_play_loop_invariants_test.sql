...
INSERT INTO entity_registry (entity_id, world_id, entity_kind, canonical_name) VALUES
 ('e5ffffff-0000-0000-0000-000000000010','11111111-1111-1111-1111-111111111111','location','test-tavern-98'),
 ('e5ffffff-0000-0000-0000-000000000011','11111111-1111-1111-1111-111111111111','location','test-square-98');
...
-- the move projection is present (Player at square-uuid after the beat)
SELECT is((SELECT attrs->>'location_id' FROM actor_state WHERE entity_id='aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'),
          'e5ffffff-0000-0000-0000-000000000011', 'projection reflects the committed move');
