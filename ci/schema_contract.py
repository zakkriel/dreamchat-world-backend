...
INPUT_CONTRACT_SCHEMAS = {"beat_chain/1", "beat_chain/2", "ruling/1", "ruling/2", "npc_attempts/1", "narration/3", "speech_perception/1"}  # Seat contracts, not projection payloads.
