...
INPUT_CONTRACT_SCHEMAS = {"beat_chain/1", "beat_chain/2", "ruling/1", "ruling/2", "npc_attempts/1", "narration/3"}  # ruling/2 + narration/3: seat contracts, no payload generator
