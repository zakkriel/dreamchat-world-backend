...
1. JRPG / visual-novel readability: visual scene, present entities, speaker focus, atmosphere.
2. Cursor-like workspace control: inspectable context, state changes, correction, structured world tools.
...
1. Main Scene Canvas
2. Scene Participants
3. Conversation / Narration Panel
4. Aux Context Sidebar
5. World Workspace Navigation
